...
module.exports = (sequelize, DataTypes) => {
  class SectionStudents extends Model {
    ...
    static associate(models) {
      ...
      const { SectionStudents, Enrollees, Sections } = models

      SectionStudents.belongsTo(Enrollees, {
        foreignKey: 'enrolleeId',
        targetKey: 'id',
        as: 'enrollee'
      })

      SectionStudents.belongsTo(Sections, {
